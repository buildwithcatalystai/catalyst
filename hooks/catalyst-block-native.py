...
def main() -> int:
    ...
    reason = (
        ...
        f"If you need native tools right now, switch to the Analyst — "
        f"`start_analysis` — where every native tool is open, and come back to "
        f"Build after. Do NOT call `abandon_build` for this: it marks the "
